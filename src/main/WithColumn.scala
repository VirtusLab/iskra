...
object WithColumn:
  ...
  def withColumnImpl[Schema : Type, DF <: DataFrame[Schema] : Type](df: Expr[DF])(using Quotes): Expr[WithColumn[Schema, ?]] =
  ...
  given withColumnApply: {} with
    extension [Schema, View <: SchemaView](withColumn: WithColumn[Schema, View])
      transparent inline def apply[N <: Name, Col](name: N, column: View ?=> Col): DataFrame[?] =
